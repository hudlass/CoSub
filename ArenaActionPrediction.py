...
def main(puzzleState, puzzleSize, puzzleType):
    ...
    with tf.Session() as sess:
        ...
        saver.restore(sess, "DeepLearning/ModelCheckpoints/3x3x3FirstActionAndLengthsModel002.ckpt")
...
#main("WRGWROBBBYBBGGRWWWWGOYOOROOYYGYBGYBROGGWYRRRROOGYWBYWB", 3, "Twisty")

# solutionLengths = []
# for i in range(1000):
#     print("Counter: " + str(i))
#     solutionLengths.append(main([[8,0,7],[4,1,2],[6,3,5]], 8, "SlidingTile"))
