###### RESULTS AFTER TRAINING! 13.48% Accurate!
...
def main():
    ...
    with tf.Session() as sess:
        ...
        save_path = saver.save(sess, "ModelCheckpoints/3x3x3FirstActionsOnlyModel002.ckpt")
