...
data = list(csv.reader(open('../Data/3x3x3LengthsOnly001.csv')))
data = data[::2]
print(len(data))
...
def main():
    ...
    with tf.Session() as sess:
        ...
        save_path = saver.save(sess, "ModelCheckpoints/3x3x3JustLengthsModel001.ckpt")
        print("Model saved in path: %s" % save_path)

#
# Statistics:
# Accuracy:              15% (31906/200000)
# Mean square error:     16.75876
# Absolute deviation:    3.07185
# Average deviation:     0.1639
# Inconsistency:         2.90795
# Standard deviation:    4.09046412892
#
# Model saved in path: ModelCheckpoints/3x3x3JustLengthsModel001.ckpt
